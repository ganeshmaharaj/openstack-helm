...
export POD_START_TIMEOUT_OPENSTACK=${POD_START_TIMEOUT_OPENSTACK:="1200"}
export POD_START_TIMEOUT_DEFAULT=${POD_START_TIMEOUT_DEFAULT:="480"}
export POD_START_TIMEOUT_CEPH=${POD_START_TIMEOUT_CEPH:="1200"}
export SERVICE_TEST_TIMEOUT=${SERVICE_TEST_TIMEOUT:="600"}

# Setup Loopback device options
export LOOPBACK_CREATE=${LOOPBACK_CREATE:="true"}
export LOOPBACK_DEV_COUNT=${LOOPBACK_DEV_COUNT:="3,3,3"}
export LOOPBACK_SIZES=${LOOPBACK_SIZES:="8192M,8192M,1024M"}
...
#For Ceph OSD Directory, need to label nodes properly. Specify multiple lables seperated by commas
export CEPH_OSD_DIRECTORY_DEFAULT_LABELS=${CEPH_DIRECTORY_OSD_DEFAULT_LABELS:="var-lib-ceph-osd"}
