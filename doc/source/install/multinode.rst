...
You must select one or more disks attached to your hosts for Ceph object storage
(these disks, and the daemons associated with them, are called "OSDs") and
journals.  Each OSD requires a journal.  OSDs typically occupy entire disks
while journals, which only require about 5-10GB of space, may be placed in
partitions.  You need not choose the same disks on every host.
